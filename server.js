...
app.use('/admin/translations',verifyJWT,translationRouter);
app.use('/admin/availability',verifyJWT,availabilityRouter);

app.use('/admin/equipments',verifyJWT,equipmentRouter);
app.use('/admin/lessons',verifyJWT,lessonRouter);
app.use('/admin/transfers',verifyJWT,transferRouter);
app.use('/admin/target',verifyJWT,targetRouter);
